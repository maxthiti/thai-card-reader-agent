...
const ThaiIDCardReader = require('./node_modules/thai-id-card-reader/build/src/ThaiIDCardReader').default;
...
const normalizeCardData = (data) => {
    ...
    const fullNameTH = data.fullNameTH || [titleTH, firstNameTH, lastNameTH].filter(Boolean).join(' ').trim();
